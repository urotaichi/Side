    ...
    public partial class MainWindow : Form
    {
        ...
        private void ChipList_DrawItem(object sender, DrawItemEventArgs e)
        {
            ...
            try
            {
                ...
                if (!ChipList.Enabled) e.Graphics.FillRectangle(new SolidBrush(Color.FromArgb(160, (Global.state.DarkMode == SystemColorMode.Classic) ? Color.White : Color.Black)), e.Bounds); // 無効時に白くする
            }
            catch
            {
            }
        ...
        private void MainWindow_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (e.CloseReason != CloseReason.ApplicationExitCall)
            {
                ...
                Global.config.localSystem.LastLaunchedVersion = Global.definition.Version;
