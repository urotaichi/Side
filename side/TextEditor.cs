...
namespace MasaoPlus
{
    public class TextEditor : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            TextEditorTable.Location = new Point(0, LogicalToDeviceUnits(25));
            ...
            TextRuler.Size = LogicalToDeviceUnits(new Size(511, 21));
            ...
            TextLineNo.Size = LogicalToDeviceUnits(new Size(38, 190));
            ...
            TextBoxOwnerPanel.Location = new Point(LogicalToDeviceUnits(40), LogicalToDeviceUnits(23));
            TextBoxOwnerPanel.Margin = new Padding(0);
            TextBoxOwnerPanel.Name = "TextBoxOwnerPanel";
            TextBoxOwnerPanel.Padding = new Padding(1);
            TextBoxOwnerPanel.Size = LogicalToDeviceUnits(new Size(513, 192));
            ...
            StageTextEditor.Location = new Point(LogicalToDeviceUnits(1), LogicalToDeviceUnits(1));
            StageTextEditor.Margin = new Padding(1);
            StageTextEditor.Name = "StageTextEditor";
            StageTextEditor.Size = LogicalToDeviceUnits(new Size(511, 190));
            ...
            TextPositionInfo.Size = LogicalToDeviceUnits(new Size(42, 22));
            TextPositionInfo.Text = "None";
            TextPositionInfo.TextAlign = ContentAlignment.MiddleLeft;
            TextStatus.Name = "TextStatus";
            TextStatus.Size = LogicalToDeviceUnits(new Size(226, 22));
            ...
            LineInfo.Size = LogicalToDeviceUnits(new Size(66, 22));
            ...
            StageLayer.Size = LogicalToDeviceUnits(new Size(29, 22));
            ...
            PatternChipLayer.Size = LogicalToDeviceUnits(new Size(247, 22));
            ...
            TextUndo.Size = LogicalToDeviceUnits(new Size(23, 22));
            TextUndo.Text = "元に戻す";
            ...
            TextRedo.Size = LogicalToDeviceUnits(new Size(23, 22));
            TextRedo.Text = "やり直し";
            ...
            TextCut.Size = LogicalToDeviceUnits(new Size(23, 22));
            TextCut.Text = "切り取り";
            ...
            TextCopy.Size = LogicalToDeviceUnits(new Size(23, 22));
            TextCopy.Text = "コピー";
            ...
            TextPaste.Size = LogicalToDeviceUnits(new Size(23, 22));
            TextPaste.Text = "ペースト";
            TextPaste.Click += TextPaste_Click;
            toolStripSeparator9.Name = "toolStripSeparator9";
            toolStripSeparator9.Size = LogicalToDeviceUnits(new Size(6, 25));
            ...
            TextProjConfig.Size = LogicalToDeviceUnits(new Size(23, 22));
            ...
            TextTestRun.Size = LogicalToDeviceUnits(new Size(23, 22));
            ...
            Name = "TextEditor";
            Size = LogicalToDeviceUnits(new Size(553, 267));
