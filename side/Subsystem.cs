        ...
        public static string MakeHTMLCode(int StartStage, int ReplaceStage, string[] sts, bool isJSON = false)
        {
            ...
            if (isJSON)
            {
                ...
                while (k < configurations.Length)
                {
                    ...
                    if (configParam.Category == "オプション") goto IL_SKIP_JSON;
                ...
                IL_SKIP_PARAM:
                    if (!Global.config.localSystem.OutPutInititalSourceCode && !Global.cpd.runtime.Definitions.Package.Contains("28"))
                    {
                        ...
                        {
                            case "mes1_name":
                                if (configParam.Value == "ダケシ") goto IL_SKIP_JSON;
                                else break;
                            case "serifu1":
                            ...
                            case "serifu2":
                                if (configParam.Value ==
                                    "時は金なりと、言われています。しかし、\r\nお店なら、時間も買えます。\r\n店員さんて、グレートですね。") goto IL_SKIP_JSON;
                                else break;
                            case "mes2_name":
                                if (configParam.Value == "エリコ") goto IL_SKIP_JSON;
                                else break;
                            case "serifu3":
                                if (configParam.Value ==
                                    "おはようございます。星と数字が付いた扉が、\r\nありますよね。あれは、ですねえ、その数だけ\r\n人面星を取ると、開くので、ございます。") goto IL_SKIP_JSON;
                                else break;
                            case "serifu4":
                                if (configParam.Value ==
                                    "LAST STAGEというのは、最終面の事ですわ。\r\nこれをクリアーすると、エンディングに、\r\n行けますのよ。がんばって下さいね。") goto IL_SKIP_JSON;
                                else break;
                            case "shop_name":
                                if (configParam.Value == "店員さん") goto IL_SKIP_JSON;
                                else break;
                            case "serifu5":
                                if (configParam.Value ==
                                    "いらっしゃいませ。\r\n当店では、ＳＣＯＲＥと、アイテムを、\r\n交換いたします。") goto IL_SKIP_JSON;
                                else break;
                            case "serifu8":
                                if (configParam.Value ==
                                    "本日の営業は、終了いたしました。\r\nまたのご来店を、\r\nこころより、お待ちしております。") goto IL_SKIP_JSON;
                                else break;
                            case "shop_serifu1":
                                if (configParam.Value == "どれになさいますか？") goto IL_SKIP_JSON;
                                else break;
                            case "shop_serifu2":
                                if (configParam.Value == "で、よろしいですか？") goto IL_SKIP_JSON;
                                else break;
                            case "shop_serifu3":
                            case "serifu_key1_on-5":
                            case "serifu_key2_on-5":
                                if (configParam.Value == "はい") goto IL_SKIP_JSON;
                                else break;
                            case "shop_serifu4":
                            case "serifu_key1_on-6":
                            case "serifu_key2_on-6":
                                if (configParam.Value == "いいえ") goto IL_SKIP_JSON;
                                else break;
                            case "shop_serifu5":
                                if (configParam.Value == "を、装備した。") goto IL_SKIP_JSON;
                                else break;
                            case "shop_serifu6":
                                if (configParam.Value == "ＳＣＯＲＥが、足りません。") goto IL_SKIP_JSON;
                                else break;
                            case "shop_item_name1":
                                if (configParam.Value == "グレネード３発") goto IL_SKIP_JSON;
                                else break;
                            case "shop_item_name2":
                            case "setumei_menu4":
                                if (configParam.Value == "ジェット") goto IL_SKIP_JSON;
                                else break;
                            case "shop_item_name3":
                                if (configParam.Value == "ドリル") goto IL_SKIP_JSON;
                                else break;
                            case "shop_item_name4":
                                if (configParam.Value == "ヘルメット") goto IL_SKIP_JSON;
                                else break;
                            case "shop_item_name5":
                                if (configParam.Value == "しっぽ") goto IL_SKIP_JSON;
                                else break;
                            case "shop_item_name6":
                            case "setumei_menu3":
                                if (configParam.Value == "バリア") goto IL_SKIP_JSON;
                                else break;
                            case "shop_item_name7":
                            case "setumei_menu2":
                                if (configParam.Value == "ファイヤーボール") goto IL_SKIP_JSON;
                                else break;
                            case "shop_item_name8":
                                if (configParam.Value == "１ｕｐ") goto IL_SKIP_JSON;
                                else break;
                            case "shop_item_name9":
                                if (configParam.Value == "制限時間増加") goto IL_SKIP_JSON;
                                else break;
                            case "shop_item_teika1":
                                if (configParam.Value == "200") goto IL_SKIP_JSON;
                                else break;
                            case "shop_item_teika2":
                                if (configParam.Value == "150") goto IL_SKIP_JSON;
                                else break;
                            case "shop_item_teika3":
                            case "shop_item_teika4":
                                if (configParam.Value == "100") goto IL_SKIP_JSON;
                                else break;
                            case "shop_item_teika5":
                                if (configParam.Value == "250") goto IL_SKIP_JSON;
                                else break;
                            case "shop_item_teika6":
                                if (configParam.Value == "80") goto IL_SKIP_JSON;
                                else break;
                            case "shop_item_teika7":
                            case "time_max":
                                if (configParam.Value == "300") goto IL_SKIP_JSON;
                                else break;
                            case "shop_item_teika8":
                                if (configParam.Value == "980") goto IL_SKIP_JSON;
                                else break;
                            ...
                            case "oriboss_destroy":
                                if (configParam.Value == "1") goto IL_SKIP_JSON;
                                else break;
                            case "setumei_name":
                                if (configParam.Value == "キドはかせ") goto IL_SKIP_JSON;
                                else break;
                            case "serifu9":
                                if (configParam.Value ==
                                    "よく来た。わしは、キドはかせ。\r\nアイテムの研究をしており、みんなから、\r\nアイテムはかせと呼ばれて、したわれておるよ。") goto IL_SKIP_JSON;
                                else break;
                            case "setumei_menu1":
                                if (configParam.Value == "なんでも、質問してくれたまえよ。") goto IL_SKIP_JSON;
                                else break;
                            case "serifu10":
                                if (configParam.Value ==
                                    "黄色いチューリップのアイテムと言えば、\r\nそう、ファイヤーボールじゃな。はなれた\r\n敵を攻撃できるという、大変便利なものじゃ。") goto IL_SKIP_JSON;
                                else break;
                            case "serifu11":
                                if (configParam.Value ==
                                    "ピンクのキノコのアイテムと言えば、そう、\r\nバリアじゃな。体当たりで敵を倒せるが、うっかり\r\nして、時間切れを忘れぬよう、注意が必要じゃ。") goto IL_SKIP_JSON;
                                else break;
                            case "serifu12":
                                if (configParam.Value ==
                                    "ロケットの形のアイテムと言えば、そう、ジェット\r\nじゃな。空中で、スペースキーを押せば、さらに\r\n上昇できる。燃料切れには、気を付けるのじゃぞ。") goto IL_SKIP_JSON;
                                else break;
                            case "door_score":
                                if (configParam.Value == "800") goto IL_SKIP_JSON;
                                else break;
                            case "layer_mode":
                            case "score_v":
                            case "j_tail_hf":
                            ...
                            case "oriboss_tail_f":
                                if (configParam.Value == "true") goto IL_SKIP_JSON;
                                else break;
                            case "filename_mapchip":
                                if (configParam.Value == "mapchip.gif") goto IL_SKIP_JSON;
                                else break;
                            case "filename_haikei":
                            case "filename_haikei2":
                            case "filename_haikei3":
                            case "filename_haikei4":
                                if (configParam.Value == "haikei.gif") goto IL_SKIP_JSON;
                                else break;
                            case "gazou_scroll":
                            case "mcs_screen_size":
                                if (configParam.Value == "2") goto IL_SKIP_JSON;
                                else break;
                            case "now_loading":
                            case "j_hp_name":
                            case "oriboss_name":
                            ...
                            case "x_backimage4_filename":
                                if (configParam.Value == string.Empty) goto IL_SKIP_JSON;
                                else break;
                            case "score_1up_1":
                                if (configParam.Value == "500") goto IL_SKIP_JSON;
                                else break;
                            case "score_1up_2":
                                if (configParam.Value == "1000") goto IL_SKIP_JSON;
                                else break;
                            case "url1":
                            case "url2":
                            case "url3":
                                if (configParam.Value == "http://www.yahoo.co.jp/") goto IL_SKIP_JSON;
                                else break;
                            case "url4":
                                if (configParam.Value == "http://www.t3.rim.or.jp/~naoto/naoto.html") goto IL_SKIP_JSON;
                                else break;
                            case "hitokoto1_name":
                                if (configParam.Value == "浩二") goto IL_SKIP_JSON;
                                else break;
                            case "hitokoto1":
                            ...
                            case "serifu_key1_on_name":
                                if (configParam.Value == "お姫様") goto IL_SKIP_JSON;
                                else break;
                            case "hitokoto2":
                            ...
                            case "serifu_key2_on_name":
                                if (configParam.Value == "ザトシ") goto IL_SKIP_JSON;
                                else break;
                            case "hitokoto3":
                            ...
                            case "serifu_grenade_shop_name":
                                if (configParam.Value == "クリス") goto IL_SKIP_JSON;
                                else break;
                            case "hitokoto4":
                            ...
                            case "backcolor_@_f":
                            case "message_name_@":
                                if (configParam.Value == "0,255,255") goto IL_SKIP_JSON;
                                else break;
                            case "kaishi_@":
                            case "message_back_@":
                                if (configParam.Value == "0,0,0") goto IL_SKIP_JSON;
                                else break;
                            case "scorecolor_@":
                                if (configParam.Value == "0,0,255") goto IL_SKIP_JSON;
                                else break;
                            case "grenade_@1":
                            case "message_border_@":
                            case "message_text_@":
                            case "gauge_border_@":
                                if (configParam.Value == "255,255,255") goto IL_SKIP_JSON;
                                else break;
                            case "grenade_@2":
                            case "gauge_back_@1":
                                if (configParam.Value == "255,255,0") goto IL_SKIP_JSON;
                                else break;
                            case "mizunohadou_@":
                                if (configParam.Value == "0,32,255") goto IL_SKIP_JSON;
                                else break;
                            case "firebar_@1":
                            case "gauge_back_@2":
                                if (configParam.Value == "255,0,0") goto IL_SKIP_JSON;
                                else break;
                            case "firebar_@2":
                                if (configParam.Value == "255,192,0") goto IL_SKIP_JSON;
                                else break;
                            case "moji_score":
                                if (configParam.Value == "SCORE") goto IL_SKIP_JSON;
                                else break;
                            case "moji_highscore":
                                if (configParam.Value == "HIGHSCORE") goto IL_SKIP_JSON;
                                else break;
                            case "moji_time":
                                if (configParam.Value == "TIME") goto IL_SKIP_JSON;
                                else break;
                            case "moji_jet":
                                if (configParam.Value == "JET") goto IL_SKIP_JSON;
                                else break;
                            case "moji_grenade":
                                if (configParam.Value == "GRENADE") goto IL_SKIP_JSON;
                                else break;
                            case "moji_left":
                                if (configParam.Value == "LEFT") goto IL_SKIP_JSON;
                                else break;
                            case "moji_size":
                                if (configParam.Value == "14") goto IL_SKIP_JSON;
                                else break;
                            case "filename_title":
                                if (configParam.Value == "title.gif") goto IL_SKIP_JSON;
                                else break;
                            case "filename_ending":
                                if (configParam.Value == "ending.gif") goto IL_SKIP_JSON;
                                else break;
                            case "filename_gameover":
                                if (configParam.Value == "gameover.gif") goto IL_SKIP_JSON;
                                else break;
                            case "filename_pattern":
                                if (configParam.Value == "pattern.gif") goto IL_SKIP_JSON;
                                else break;
                            case "filename_chizu":
                                if (configParam.Value == "chizu.gif") goto IL_SKIP_JSON;
                                else break;
                            case "game_speed":
                                if (configParam.Value == "70") goto IL_SKIP_JSON;
                                else break;
                            case "se_switch":
                            case "se_filename":
                            case "fx_bgm_switch":
                            ...
                            case "audio_bgm_switch_wave":
                                if (configParam.Value == "false") goto IL_SKIP_JSON;
                                else break;
                            case "filename_se_start":
                            case "filename_se_item":
                                if (reg_se_item().IsMatch(configParam.Value)) goto IL_SKIP_JSON;
                                else break;
                            case "filename_se_gameover":
                                if (reg_se_gameover().IsMatch(configParam.Value)) goto IL_SKIP_JSON;
                                else break;
                            case "filename_se_clear":
                                if (reg_se_clear().IsMatch(configParam.Value)) goto IL_SKIP_JSON;
                                else break;
                            case "filename_se_coin":
                                if (reg_se_coin().IsMatch(configParam.Value)) goto IL_SKIP_JSON;
                                else break;
                            case "filename_se_get":
                            case "filename_se_dokan":
                            case "filename_se_chizugamen":
                                if (reg_se_get().IsMatch(configParam.Value)) goto IL_SKIP_JSON;
                                else break;
                            case "filename_se_jump":
                                if (reg_se_jump().IsMatch(configParam.Value)) goto IL_SKIP_JSON;
                                else break;
                            case "filename_se_sjump":
                                if (reg_se_sjump().IsMatch(configParam.Value)) goto IL_SKIP_JSON;
                                else break;
                            case "filename_se_kiki":
                                if (reg_se_kiki().IsMatch(configParam.Value)) goto IL_SKIP_JSON;
                                else break;
                            case "filename_se_fumu":
                                if (reg_se_fumu().IsMatch(configParam.Value)) goto IL_SKIP_JSON;
                                else break;
                            case "filename_se_tobasu":
                                if (reg_se_tobasu().IsMatch(configParam.Value)) goto IL_SKIP_JSON;
                                else break;
                            case "filename_se_fireball":
                            case "filename_se_bomb":
                            case "filename_se_senkuuza":
                                if (reg_se_shot().IsMatch(configParam.Value)) goto IL_SKIP_JSON;
                                else break;
                            case "filename_se_jet":
                            case "filename_se_dengeki":
                            case "filename_se_hinoko":
                            case "filename_se_grounder":
                                if (reg_se_mgan().IsMatch(configParam.Value)) goto IL_SKIP_JSON;
                                else break;
                            case "filename_se_miss":
                            case "filename_se_dosun":
                                if (reg_se_dosun().IsMatch(configParam.Value)) goto IL_SKIP_JSON;
                                else break;
                            case "filename_se_block":
                                if (reg_se_bakuhatu().IsMatch(configParam.Value)) goto IL_SKIP_JSON;
                                else break;
                            case "filename_se_mizu":
                                if (reg_se_mizu().IsMatch(configParam.Value)) goto IL_SKIP_JSON;
                                else break;
                            case "filename_se_happa":
                            case "filename_se_mizudeppo":
                            case "filename_se_kaiole":
                                if (reg_se_happa().IsMatch(configParam.Value)) goto IL_SKIP_JSON;
                                else break;
                            case "filename_fx_bgm_stage1":
                                if (reg_bgm_stage1().IsMatch(configParam.Value)) goto IL_SKIP_JSON;
                                else break;
                            case "filename_fx_bgm_stage2":
                                if (reg_bgm_stage2().IsMatch(configParam.Value)) goto IL_SKIP_JSON;
                                else break;
                            case "filename_fx_bgm_stage3":
                                if (reg_bgm_stage3().IsMatch(configParam.Value)) goto IL_SKIP_JSON;
                                else break;
                            case "filename_fx_bgm_stage4":
                                if (reg_bgm_stage4().IsMatch(configParam.Value)) goto IL_SKIP_JSON;
                                else break;
                            case "filename_fx_bgm_boss":
                                if (reg_bgm_boss().IsMatch(configParam.Value)) goto IL_SKIP_JSON;
                                else break;
                            case "filename_fx_bgm_title":
                                if (reg_bgm_title().IsMatch(configParam.Value)) goto IL_SKIP_JSON;
                                else break;
                            case "filename_fx_bgm_ending":
                                if (reg_bgm_ending().IsMatch(configParam.Value)) goto IL_SKIP_JSON;
                                else break;
                            case "filename_fx_bgm_chizu":
                                if (reg_bgm_chizu().IsMatch(configParam.Value)) goto IL_SKIP_JSON;
                                else break;
                            ...
                            case "x_backimage4_view_x":
                                if (configParam.Value == "0") goto IL_SKIP_JSON;
                                else break;
                            case "boss_hp_max":
                            case "grenade_shop_score":
                                if (configParam.Value == "20") goto IL_SKIP_JSON;
                                else break;
                            case "j_tail_ap_boss":
                                if (configParam.Value == "4") goto IL_SKIP_JSON;
                                else break;
                            case "boss_name":
                            case "boss2_name":
                            case "boss3_name":
                                if (configParam.Value == "BOSS") goto IL_SKIP_JSON;
                                else break;
                            case "fs_name":
                                if (configParam.Value == "ファイヤーボールセレクトの人") goto IL_SKIP_JSON;
                                else break;
                            case "serifu7":
                                if (configParam.Value ==
                                    "好きなファイヤーボールを、３種類から\r\n選んで下さい。私はサービスが良いので、\r\n何度でも選べますよ。") goto IL_SKIP_JSON;
                                else break;
                            case "fs_serifu1":
                                if (configParam.Value == "どのファイヤーボールにしますか？") goto IL_SKIP_JSON;
                                else break;
                            case "fs_item_name1":
                                if (configParam.Value == "バウンド") goto IL_SKIP_JSON;
                                else break;
                            case "fs_item_name2":
                                if (configParam.Value == "ストレート") goto IL_SKIP_JSON;
                                else break;
                            case "fs_item_name3":
                                if (configParam.Value == "ダブル") goto IL_SKIP_JSON;
                                else break;
                            case "fs_serifu2":
                                if (configParam.Value == "を装備しました。") goto IL_SKIP_JSON;
                                else break;
                            case "filename_second_haikei":
                            case "filename_second_haikei2":
                            case "filename_second_haikei3":
                            case "filename_second_haikei4":
                                if (configParam.Value == "haikei_second.gif") goto IL_SKIP_JSON;
                                else break;
                            case "serifu_key1_on":
                                if (configParam.Value ==
                                    "ここから先へ進むには、\r\n３つのＫＥＹ１が必要です。\r\nこの世界のどこかに、あるはず。") goto IL_SKIP_JSON;
                                else break;
                            case "serifu_key1_on-4":
                                if (configParam.Value == "ＫＥＹ１を３つ、わたしますか？") goto IL_SKIP_JSON;
                                else break;
                            case "serifu_key1_on-7":
                                if (configParam.Value == "ＫＥＹ１を３つ、持っていません。") goto IL_SKIP_JSON;
                                else break;
                            case "serifu_key1_on-8":
                                if (configParam.Value ==
                                    "先へ進む道が、開けました。\r\n勇者殿、\r\nお気を付けて。") goto IL_SKIP_JSON;
                                else break;
                            case "key1_on_count":
                            case "key2_on_count":
                            case "oriboss_waza_select_option":
                                if (configParam.Value == "3") goto IL_SKIP_JSON;
                                else break;
                            case "serifu_key2_on":
                                if (configParam.Value ==
                                    "３つのＫＥＹ２がないと、\r\nここから先へは進めないぜ。\r\nどこかで見つ付けてくれ。") goto IL_SKIP_JSON;
                                else break;
                            case "serifu_key2_on-4":
                                if (configParam.Value == "ＫＥＹ２を３つ、わたしますか？") goto IL_SKIP_JSON;
                                else break;
                            case "serifu_key2_on-7":
                                if (configParam.Value == "ＫＥＹ２を３つ、持っていません。") goto IL_SKIP_JSON;
                                else break;
                            ...
                            case "water_clear_level":
                                if (configParam.Value == "128") goto IL_SKIP_JSON;
                                else break;
                            ...
                            case "serifu_grenade_shop-4":
                                if (configParam.Value == "何発にしますか？") goto IL_SKIP_JSON;
                                else break;
                            case "serifu_grenade_shop-5":
                                if (configParam.Value == "得点が、足りません。") goto IL_SKIP_JSON;
                                else break;
                            case "serifu_grenade_shop-6":
                                if (configParam.Value == "グレネードを手に入れた。") goto IL_SKIP_JSON;
                                else break;
                            case "font_score":
                            case "font_message":
                                if (configParam.Value == "Helvetica,Arial,ＭＳ ゴシック,HG ゴシックB Sun,HG ゴシックB,monospace") goto IL_SKIP_JSON;
                                else break;
                            case "oriboss_width":
                            case "oriboss_height":
                                if (configParam.Value == "32") goto IL_SKIP_JSON;
                                break;
                        }
                    }
                ...
                if (Global.cpd.project.Use3rdMapData)
                {
                    ...
                    if (Global.cpd.runtime.Definitions.LayerSize.bytesize != 0)
                    {
                        stringBuilder.Append(MakeStage3rdMapData(Global.cpd.runtime.Definitions.StageSize, (ReplaceStage == 0) ? sts : Global.cpd.project.StageData, Global.cpd.project.LayerData));
                        if (Global.cpd.project.Config.StageNum >= 2)
                        {
                            stringBuilder.Append(MakeStage3rdMapData(Global.cpd.runtime.Definitions.StageSize2, (ReplaceStage == 1) ? sts : Global.cpd.project.StageData2, Global.cpd.project.LayerData2));
                        }
                        if (Global.cpd.project.Config.StageNum >= 3)
                        {
                            stringBuilder.Append(MakeStage3rdMapData(Global.cpd.runtime.Definitions.StageSize3, (ReplaceStage == 2) ? sts : Global.cpd.project.StageData3, Global.cpd.project.LayerData3));
                        }
                        if (Global.cpd.project.Config.StageNum >= 4)
                        {
                            stringBuilder.Append(MakeStage3rdMapData(Global.cpd.runtime.Definitions.StageSize4, (ReplaceStage == 3) ? sts : Global.cpd.project.StageData4, Global.cpd.project.LayerData4));
                        }
                    }
                    else
                    {
