namespace MasaoPlus.Dialogs
{
	public partial class RuntimeManager : global::System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.RuntimeViewer.Location = new global::System.Drawing.Point(base.LogicalToDeviceUnits(12), base.LogicalToDeviceUnits(12));
			this.RuntimeViewer.MultiSelect = false;
			this.RuntimeViewer.Name = "RuntimeViewer";
			this.RuntimeViewer.Size = base.LogicalToDeviceUnits(new global::System.Drawing.Size(568, 201));
			...
			this.RuntimeName.Width = base.LogicalToDeviceUnits(200);
			this.Author.Text = "作者";
			this.Author.Width = base.LogicalToDeviceUnits(70);
			this.Archive.Text = "実行アーカイブ";
			this.Archive.Width = base.LogicalToDeviceUnits(120);
			this.Layer.Text = "レイヤー";
			this.Layer.Width = base.LogicalToDeviceUnits(50);
			this.Version.Text = "バージョン";
			this.Version.Width = base.LogicalToDeviceUnits(60);
			this.button1.DialogResult = global::System.Windows.Forms.DialogResult.OK;
			this.button1.Location = new global::System.Drawing.Point(base.LogicalToDeviceUnits(486), base.LogicalToDeviceUnits(219));
			this.button1.Name = "button1";
			this.button1.Size = base.LogicalToDeviceUnits(new global::System.Drawing.Size(94, 25));
			this.button1.TabIndex = 1;
			this.button1.Text = "閉じる";
			this.button1.UseVisualStyleBackColor = true;
			this.NetworkUpdate.Enabled = false;
			this.NetworkUpdate.Location = new global::System.Drawing.Point(base.LogicalToDeviceUnits(12), base.LogicalToDeviceUnits(219));
			this.NetworkUpdate.Name = "NetworkUpdate";
			this.NetworkUpdate.Size = base.LogicalToDeviceUnits(new global::System.Drawing.Size(145, 25));
			...
			this.NewRuntimeInstall.Location = new global::System.Drawing.Point(base.LogicalToDeviceUnits(289), base.LogicalToDeviceUnits(219));
			this.NewRuntimeInstall.Name = "NewRuntimeInstall";
			this.NewRuntimeInstall.Size = base.LogicalToDeviceUnits(new global::System.Drawing.Size(172, 25));
			...
			this.DownProgress.Location = new global::System.Drawing.Point(base.LogicalToDeviceUnits(50), base.LogicalToDeviceUnits(98));
			this.DownProgress.Name = "DownProgress";
			this.DownProgress.Size = base.LogicalToDeviceUnits(new global::System.Drawing.Size(488, 28));
			this.DownProgress.TabIndex = 4;
			this.DownProgress.Visible = false;
			this.Uninstall.Enabled = false;
			this.Uninstall.Location = new global::System.Drawing.Point(base.LogicalToDeviceUnits(163), base.LogicalToDeviceUnits(219));
			this.Uninstall.Name = "Uninstall";
			this.Uninstall.Size = base.LogicalToDeviceUnits(new global::System.Drawing.Size(120, 25));
			...
			base.ClientSize = base.LogicalToDeviceUnits(new global::System.Drawing.Size(592, 256));
