namespace MasaoPlus.Dialogs
{
	...
	public partial class RuntimeManager : global::System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.RuntimeViewer.Location = new global::System.Drawing.Point(12 * DeviceDpi / 96, 12 * DeviceDpi / 96);
			this.RuntimeViewer.MultiSelect = false;
			this.RuntimeViewer.Name = "RuntimeViewer";
			this.RuntimeViewer.Size = new global::System.Drawing.Size(568 * DeviceDpi / 96, 201 * DeviceDpi / 96);
			...
			this.RuntimeName.Width = 200 * DeviceDpi / 96;
			this.Author.Text = "作者";
			this.Author.Width = 70 * DeviceDpi / 96;
			this.Archive.Text = "実行アーカイブ";
			this.Archive.Width = 120 * DeviceDpi / 96;
			this.Layer.Text = "レイヤー";
			this.Layer.Width = 50 * DeviceDpi / 96;
			this.Version.Text = "バージョン";
			this.Version.Width = 60 * DeviceDpi / 96;
			this.button1.DialogResult = global::System.Windows.Forms.DialogResult.OK;
			this.button1.Location = new global::System.Drawing.Point(486 * DeviceDpi / 96, 219 * DeviceDpi / 96);
			this.button1.Name = "button1";
			this.button1.Size = new global::System.Drawing.Size(94 * DeviceDpi / 96, 25 * DeviceDpi / 96);
			this.button1.TabIndex = 1;
			this.button1.Text = "閉じる";
			this.button1.UseVisualStyleBackColor = true;
			this.NetworkUpdate.Enabled = false;
			this.NetworkUpdate.Location = new global::System.Drawing.Point(12 * DeviceDpi / 96, 219 * DeviceDpi / 96);
			this.NetworkUpdate.Name = "NetworkUpdate";
			this.NetworkUpdate.Size = new global::System.Drawing.Size(145 * DeviceDpi / 96, 25 * DeviceDpi / 96);
			...
			this.NewRuntimeInstall.Location = new global::System.Drawing.Point(289 * DeviceDpi / 96, 219 * DeviceDpi / 96);
			this.NewRuntimeInstall.Name = "NewRuntimeInstall";
			this.NewRuntimeInstall.Size = new global::System.Drawing.Size(172 * DeviceDpi / 96, 25 * DeviceDpi / 96);
			...
			this.DownProgress.Location = new global::System.Drawing.Point(50 * DeviceDpi / 96, 98 * DeviceDpi / 96);
			this.DownProgress.Name = "DownProgress";
			this.DownProgress.Size = new global::System.Drawing.Size(488 * DeviceDpi / 96, 28 * DeviceDpi / 96);
			this.DownProgress.TabIndex = 4;
			this.DownProgress.Visible = false;
			this.Uninstall.Enabled = false;
			this.Uninstall.Location = new global::System.Drawing.Point(163 * DeviceDpi / 96, 219 * DeviceDpi / 96);
			this.Uninstall.Name = "Uninstall";
			this.Uninstall.Size = new global::System.Drawing.Size(120 * DeviceDpi / 96, 25 * DeviceDpi / 96);
			...
			base.ClientSize = new global::System.Drawing.Size(592 * DeviceDpi / 96, 256 * DeviceDpi / 96);
