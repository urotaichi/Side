    ...
    public class OverViewer : Control
    {
        ...
        public new Size Size
        {
            get
            {
                ...
                {
                    return LogicalToDeviceUnits(new Size(180, 30));
                }
                return LogicalToDeviceUnits(new Size(Source.Size.Width * ppb, Source.Size.Height * ppb));
            }
            set
            {
            }
        ...
        private void OverViewer_Paint(object sender, PaintEventArgs e)
        {
            ...
            e.Graphics.DrawImage(Source, new Rectangle(new Point(0, 0), LogicalToDeviceUnits(new Size(Source.Width * ppb, Source.Height * ppb))));
            Point mapPointTranslatedMap = Global.state.MapPointTranslatedMap;
            mapPointTranslatedMap.X *= ppb;
            mapPointTranslatedMap.Y *= ppb;

            // 白枠
            using Pen pen = new(Brushes.White, LogicalToDeviceUnits(ppb));
