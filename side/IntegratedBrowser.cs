    ...
    public class IntegratedBrowser : UserControl
    {
		...
		*/
        ...
        private void InitializeComponent()
        {
            ...
            Back.Name = "Back";
            Back.Size = LogicalToDeviceUnits(new Size(23, 22));
            Back.Text = "戻る";
            ...
            Forward.Size = LogicalToDeviceUnits(new Size(23, 22));
            Forward.Text = "進む";
            ...
            Reload.Name = "Reload";
            Reload.Size = LogicalToDeviceUnits(new Size(23, 22));
            Reload.Text = "更新";
            ...
            ReRun.Name = "ReRun";
            ReRun.Size = LogicalToDeviceUnits(new Size(23, 22));
            ReRun.Text = "再度テストラン";
            ReRun.Click += ReRun_Click;
            toolStripSeparator2.Name = "toolStripSeparator2";
            toolStripSeparator2.Size = new Size(6, 25);
            URL.Name = "URL";
            URL.Size = LogicalToDeviceUnits(new Size(48, 22));
            URL.Text = "No File";
            ...
            Status.Name = "Status";
            Status.Size = LogicalToDeviceUnits(new Size(297, 18));
            Status.Spring = true;
            Status.Text = "完了";
            ...
            Browser.Location = new Point(0, LogicalToDeviceUnits(25));
            Browser.MinimumSize = LogicalToDeviceUnits(new Size(20, 20));
            Browser.Name = "Browser";
            Browser.Size = LogicalToDeviceUnits(new Size(414, 172));
            Browser.TabIndex = 2;
			...
			*/
            ...
            Size = LogicalToDeviceUnits(new Size(414, 220));
